    ...
    <div class="box">
        ...
        <h4>
            ...
            <div class="float-right">
                <a href="" class="btn btn-secondary btn-sm"><i class="fas fa-sync-alt"></i></a>
                <a href="add.php" class="btn btn-success btn-sm"><i class="fas fa-plus"></i> Tambah Dokter</a>
            </div>
        </h4>
                    ...
                    <tbody>
                        ...
                        while ($data = mysqli_fetch_array($sql_poli)) { ?>
                            <tr>
                                ...
                                <td><?= $data['no_telp']; ?></td>
                                <td align="center">
                                    <a href="edit.php?id=<?= $data['id_dokter']; ?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
                                </td>
                            </tr>
                        <?php
                        }
